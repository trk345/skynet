...
import { Mail, Phone, X, House, UserRound, Save, ArrowLeft, Upload, Building, Bed, Bath, Square, DollarSign, MapPin, AlertCircle } from 'lucide-react';
...
const CreateProperty = () => {
  ...
  const handleFileChange = (e) => {
    ...
    console.log("images Submitted", property.images);
  }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("/api/vendor/create-property", formData, {
        headers: {
